...
SPECIAL_ITEMS = [
    dict(name_zh='主廚特調', name_en="Chef's Special",
    ...
    dict(name_zh='季節限定', name_en='Seasonal Limited',
    ...
    dict(name_zh='花蓮特選', name_en='Hualien Selection',
    ...
    dict(name_zh='手作甜點', name_en='Handmade Desserts',
    ...
    dict(name_zh='在地風味', name_en='Local Flavors',
    ...
    dict(name_zh='經典組合', name_en='Classic Combo',
